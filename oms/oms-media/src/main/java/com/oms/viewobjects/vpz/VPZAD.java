...
public class VPZAD {
	...
	public String toString() {
		return "VPZAD [id=" + id + ", name=" + name + ", goalId=" + goalId + ", customId=" + customId + ", description="
				+ description + ", enabled=" + enabled + ", weight=" + weight + ", creative=" + creative + ", start="
				+ start + ", end=" + end + ", externalTrackers=" + externalTrackers + "]";
	}
